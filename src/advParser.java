...
public class advParser extends Parser {
	...
	public final AutomatonNFADefContext automatonNFADef() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 4616048880566403157L) != 0) );
			setState(172);
			transitionDef();
			setState(173);
			match(T__9);
	...
	public final ViewDefContext viewDef() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 4616048880569155669L) != 0)) {
				{
				{
				setState(336);
				viewStat();
	...
	public final ViewportOnContext viewportOn() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 4616048880767729749L) != 0) );
			setState(543);
			match(T__9);
			}
		}
