...
public interface advVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link advParser#placeElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPlaceElement(advParser.PlaceElementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link advParser#viewportInstructions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitViewportInstructions(advParser.ViewportInstructionsContext ctx);
	/**
